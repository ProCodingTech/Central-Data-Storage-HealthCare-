...
const UserSchema = new mongoose.Schema({
  ...
  roles: {
    type: [String],
    required: true,
    enum: ["Patient", "Doctor", "Nurse", "Admin", "SuperAdmin", "Pharmacist", "LabTechnician"],
...
const AdminSchema = new mongoose.Schema({
  permissions: {
    type: [String],
    default: ["create_user", "delete_user", "assign_role", "grant_permission", "view_logs"],
...
const SuperAdminSchema = new mongoose.Schema({
  permissions: {
    type: [String],
    default: ["create_admin", "delete_admin", "manage_roles", "manage_permissions", "system_configuration"],
